      ...
      <CardContent className="p-0">
        ...
        <div className="relative">
          {transformationData.transformations.length === 1 ? (
            ...
            /* Multiple transformation cards - grid layout */
            <div className="aspect-square relative">
              <div className="grid grid-cols-2 gap-0.5 h-full">
                {transformationData.transformations.slice(0, 4).map((transformation, index) => (
                  <div key={transformation.id || index} className="relative overflow-hidden">
                    <div className="grid grid-cols-2 gap-0.5 h-full">
                      {/* Before Image */}
                      <div className="relative">
                        <img
                        ...
                        <div className="absolute top-1 left-1">
                          <Badge className="text-xs bg-black/60 text-white border-0 px-1">
                            B
                          </Badge>
                        </div>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute top-1 right-1">
                          <Badge className="text-xs bg-success text-white border-0 px-1">
                            A
                          </Badge>
                        </div>
                      </div>
                ...
                {/* Fill remaining slots if less than 4 transformations */}
                {Array.from({ length: Math.max(0, 4 - transformationData.transformations.length) }).map((_, index) => (

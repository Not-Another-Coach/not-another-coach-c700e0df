...
export const addCoachDeclineBehaviorArticle = async () => {
  const article = {
...
3. **Admin Cleanup**:
   ...
   - Preserves audit trail in admin logs`,
    ...
    content_type: 'business_rule' as const,
  ...
  try {
    ...
    console.log('Coach decline behavior article added to knowledge base:', data);
    return data;
  } catch (error) {
    console.error('Failed to add coach decline behavior article:', error);
    throw error;
  }
};
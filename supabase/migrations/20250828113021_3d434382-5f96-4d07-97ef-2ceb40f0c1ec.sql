-- Fix the cleanup function - messages don't have recipient_id, they're linked via conversations
...
BEGIN
  ...
  -- 19. Delete alerts (user_alerts table doesn't exist, skip this)
  ...
  alerts_count := 0;  -- Set to 0 since we're skipping this

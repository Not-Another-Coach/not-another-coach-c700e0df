-- Add new engagement stage for discovery in progress
ALTER TYPE engagement_stage ADD VALUE 'discovery_in_progress' AFTER 'discovery_call_booked';

-- Update the function to use discovery_in_progress instead of discovery_completed

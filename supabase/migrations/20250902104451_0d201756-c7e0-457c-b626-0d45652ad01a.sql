-- Final corrected data migration with proper type casting
...
ON CONFLICT (id) DO UPDATE SET
  ...
  works_bank_holidays = EXCLUDED.works_bank_holidays,
...
-- Migrate existing client data to client_profiles with proper boolean casting
...
SELECT 
  ...
  CASE 
    WHEN LOWER(p.waitlist_preference) = 'true' THEN true
    WHEN LOWER(p.waitlist_preference) = 'false' THEN false
    ELSE NULL
  END as waitlist_preference,

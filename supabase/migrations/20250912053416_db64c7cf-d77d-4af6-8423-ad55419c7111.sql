-- Clean up Trainer 5's certificate data
...
-- Also clean up any general certificates that might exist
DELETE FROM trainer_verification_checks 
WHERE trainer_id = '5193e290-0570-4d77-b46a-e0e21ea0aac3' 
AND check_type IN ('professional_qualifications', 'certifications');
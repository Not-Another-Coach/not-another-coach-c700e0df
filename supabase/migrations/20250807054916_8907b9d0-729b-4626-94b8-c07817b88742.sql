-- Drop and recreate the function with the correct parameter order as suggested by the error
...
GRANT EXECUTE ON FUNCTION public.create_coach_selection_request(text, text, text, text, numeric, uuid) TO anon;
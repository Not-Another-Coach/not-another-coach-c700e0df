-- Fix the admin_update_verification_check function to remove any email column references
-- and ensure proper trainer notifications
...
BEGIN
  ...
  -- Get trainer profile (avoid email column reference)
  ...
  -- Create notification for trainer (this will appear on trainer dashboard)
  INSERT INTO alerts (
    alert_type,
    title,
    content,

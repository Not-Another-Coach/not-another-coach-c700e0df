-- Drop and recreate the create_coach_selection_request function with proper permissions
...
-- Grant execute permissions to anon users as well (in case there are issues with auth)

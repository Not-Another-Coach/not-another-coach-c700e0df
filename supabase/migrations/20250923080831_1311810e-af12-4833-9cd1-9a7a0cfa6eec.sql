-- Add 'guest' to the engagement_stage_group enum
ALTER TYPE engagement_stage_group ADD VALUE 'guest';

-- Update system_visibility_defaults to include guest defaults

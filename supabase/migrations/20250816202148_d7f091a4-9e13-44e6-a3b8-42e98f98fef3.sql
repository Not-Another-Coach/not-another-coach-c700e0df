-- Manually copy tasks for the existing active template assignment (fixed version)
DO $$
DECLARE
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO client_onboarding_progress (
            ...
            NULL, -- Use NULL instead of the getting_started_task.id
    ...
    LOOP
        ...
        INSERT INTO client_onboarding_progress (
            ...
            assignment_record.client_id,
            assignment_record.trainer_id,
            NULL, -- Use NULL instead of the first_week_task.id

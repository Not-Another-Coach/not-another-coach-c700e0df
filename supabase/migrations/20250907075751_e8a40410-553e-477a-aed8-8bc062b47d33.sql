-- Fix database functions that incorrectly reference email column from profiles table
-- The email column exists in auth.users, not profiles

-- Fix check_verification_expiry function

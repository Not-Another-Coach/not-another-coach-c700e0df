...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_profiles_user_type ON public.profiles(user_type) WHERE user_type IS NOT NULL;
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_roles_user_role ON public.user_roles(user_id, role);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_onboarding_templates_trainer ON public.onboarding_templates(trainer_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_conversations_participants ON public.conversations(client_id, trainer_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_alerts_target_audience ON public.alerts USING GIN(target_audience) WHERE is_active = true;
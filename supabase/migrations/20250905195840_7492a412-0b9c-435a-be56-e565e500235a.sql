-- Activity Consolidation Migration - Simplified
...
-- Create audit log for this consolidation
...
VALUES (
  ...
  'Consolidated duplicate system activities into 17 enhanced activities with proper categorization and enhanced features'
);
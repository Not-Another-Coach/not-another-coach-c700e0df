-- Step 1: Add professional_milestones to trainer_profiles if it doesn't exist
ALTER TABLE trainer_profiles 
ADD COLUMN IF NOT EXISTS professional_milestones jsonb;

-- Step 2: Remove duplicate trainer-specific columns from profiles table
ALTER TABLE profiles 
DROP COLUMN IF EXISTS admin_review_notes,
DROP COLUMN IF EXISTS how_started,
DROP COLUMN IF EXISTS philosophy,
DROP COLUMN IF EXISTS professional_milestones;

-- Step 3: Update v_trainers view to pull from correct tables
